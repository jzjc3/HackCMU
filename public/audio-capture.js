class CaptureProcessor extends AudioWorkletProcessor {
  ...
  process(inputs){
    ...
    while(sourceOffset<channel.length){
      ...
      if(this.offset===this.buffer.length){const packet=this.buffer;this.port.postMessage(packet,[packet.buffer]);this.buffer=new Float32Array(2048);this.offset=0}
    }
    return true;
  }
}
registerProcessor('mind-travel-capture',CaptureProcessor);
