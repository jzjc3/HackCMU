...
export function RealtimeVoice({controller,world,disabled=false}:{controller:ConversationController;world:World;disabled?:boolean}){
  ...
  if(state.mode==='text')return <Button variant="outline" size="sm" style={{width:'100%',justifyContent:'center',gap:8}} disabled={disabled} onClick={()=>void start()}><span aria-hidden="true">◉</span>Talk live with Grok</Button>;
